...
- Teléfono (campo tipo string hasta 30 caracteres)
- Empresa (campo tipo string hasta 50 caracteres)
- Sector (Despliega opciones)
--- Retail & E-commerce
--- Manufactura
--- Finanzas & Seguros
--- Salud & Farmacéutico
...
--- Energía & Utilities
--- Otro
- Nivel de madurez de la empresa *si no lo conoces puedes dar clic aquí para revisar nuestro marco de referencia e identificar el nivel de madurez (despliega opciones)
--- Nivel 1
--- Nivel 2
--- Nivel 3
--- Nivel 4
--- Nivel 5
- Problema o duda a resolver (campo tipo string de hasta 500 caracteres)
- Te podemos escribir por WhatsApp (checkbox)
